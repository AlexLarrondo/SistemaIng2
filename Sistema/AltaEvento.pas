...
begin
  ...
  DM.EventosActivos.Parameters.ParamByName('Fecha1').Value:= Datetostr(DateTimePicker1.Date);
  ...
  If Edit1.Text='' then
     MessageDlg('Falta ingresar el nombre del evento',mterror,[mbOk],0)
      ...
      If DM.EventosActivos.Locate('Nombre',Edit1.Text,[]) then
        MessageDlg('Este evento ya se encuentra activo ó se encontrará activo para las fechas elegidas',mterror,[mbOk],0)
        else
